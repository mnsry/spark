...
(263, NULL, 31, 'معاوضه محل', 'moavezemahal', 'SELECT', 1, NULL, NULL),
(264, NULL, 32, 'معاوضه مبلغ', 'moavezeprice', 'NUMBER', 1, NULL, NULL),
(265, NULL, 33, 'توضیحات', 'about', 'TEXTAREA', 0, NULL, NULL),
(266, NULL, 34, 'عکس', 'image', 'IMAGE', 0, NULL, NULL),
(267, NULL, 25, 'ویدیو', 'video', 'VIDEO', 1, NULL, NULL),
