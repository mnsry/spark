...
(1, NULL, 1, 'انتخاب سن بنا', 'sen-bana', 'SELECT', 0, NULL, NULL),
(2, NULL, 2, 'انتخاب طبقه', 'tabaghe', 'SELECT', 0, NULL, NULL),
(3, NULL, 3, 'کل واحد ها', 'kol_vahed', 'SELECT', 0, NULL, NULL),
(4, NULL, 4, 'تعداد اتاق', 'otagh', 'SELECT', 0, NULL, NULL),
(5, NULL, 5, 'انتخاب سند', 'sanad', 'SELECT', 0, NULL, NULL),
(6, NULL, 6, 'کف پوش', 'kafpoosh', 'SELECT', 0, NULL, NULL),
(7, NULL, 7, 'انتخاب جهت', 'jahat', 'SELECT', 0, NULL, NULL),
(8, NULL, 8, 'انتخاب کابینت', 'kabinet', 'SELECT', 0, NULL, NULL),
(9, NULL, 9, 'گرمایش', 'hot', 'SELECT', 0, NULL, NULL),
(10, NULL, 10, 'امتیازات', 'emtiyza', 'MULTISELECT', 0, NULL, NULL),
(11, NULL, 11, 'انتخاب محل', 'mahal', 'SELECT', 0, NULL, NULL),
...
(28, 2, 2, 'همکف', 'tabaghe-hamkaf', 'NULL', 0, NULL, NULL),
(29, 2, 3, '1', 'tabaghe-1', 'NULL', 0, NULL, NULL),
(30, 2, 4, '2', 'tabaghe-2', 'NULL', 0, NULL, NULL),
(31, 2, 5, '3', 'tabaghe-3', 'NULL', 0, NULL, NULL),
(32, 2, 6, '4', 'tabaghe-4', 'NULL', 0, NULL, NULL),
(33, 2, 7, '5', 'tabaghe-5', 'NULL', 0, NULL, NULL),
(34, 2, 8, '6', 'tabaghe-6', 'NULL', 0, NULL, NULL),
(35, 2, 9, '7', 'tabaghe-7', 'NULL', 0, NULL, NULL),
(36, 2, 10, '8', 'tabaghe-8', 'NULL', 0, NULL, NULL),
(37, 2, 11, '9', 'tabaghe-9', 'NULL', 0, NULL, NULL),
(38, 2, 12, '10', 'tabaghe-10', 'NULL', 0, NULL, NULL),
...
(94, 11, 5, 'عسکریه', 'loc-5', 'NULL', 0, NULL, NULL),
(95, 11, 6, 'کوشش', 'loc-6', 'NULL', 0, NULL, NULL),
(96, 11, 7, 'خلج', 'loc-7', 'NULL', 0, NULL, NULL),
(97, 11, 8, 'سبحان', 'loc-8', 'NULL', 0, NULL, NULL),
(98, 11, 9, 'ریاضی', 'loc-9', 'NULL', 0, NULL, NULL),
(99, 11, 10, 'نقیبی فرد', 'loc-10', 'NULL', 0, NULL, NULL),
...
(103, 11, 14, 'سپاه', 'loc-14', 'NULL', 0, NULL, NULL),
(104, 11, 15, 'شهرک ابوذر', 'loc-15', 'NULL', 0, NULL, NULL),
(105, 11, 16, 'اول صبا تا میدان', 'loc-16', 'NULL', 0, NULL, NULL),
(106, 11, 17, 'میدان صبا تا پایانه اتوبوسرانی', 'loc-17', 'NULL', 0, NULL, NULL),
(107, 11, 18, 'ثامن', 'loc-18', 'NULL', 0, NULL, NULL),
(108, NULL, 12, 'قیمت', 'price', 'NUMBER', 0, NULL, NULL),
(109, NULL, 13, 'رهن', 'rahn', 'NUMBER', 0, NULL, NULL),
(110, NULL, 14, 'اجاره', 'ejare', 'NUMBER', 0, NULL, NULL),
(111, NULL, 15, 'بالکن', 'balkon', 'CHECKBOX', 0, NULL, NULL),
(112, NULL, 16, 'پارکینگ', 'parking', 'CHECKBOX', 0, NULL, NULL),
(113, NULL, 17, 'توالت فرنگی', 'farangi', 'CHECKBOX', 0, NULL, NULL),
(114, NULL, 18, 'معاوضه', 'moaveze', 'CHECKBOX', 0, NULL, NULL),
(115, NULL, 19, 'عکس', 'image', 'IMAGE', 0, NULL, NULL),
(116, NULL, 20, 'ادرس', 'address', 'TEXT', 0, NULL, NULL),
(117, NULL, 21, 'توضیحات', 'more', 'TEXTAREA', 0, NULL, NULL),
(118, NULL, 22, 'متراژ', 'metr', 'NUMBER', 0, NULL, NULL),
(119, NULL, 23, 'متراژ زمین', 'metr_zamin', 'NUMBER', 0, NULL, NULL),
(120, NULL, 24, 'آسانسور', 'elvator', 'CHECKBOX', 0, NULL, NULL),
(121, NULL, 25, 'بازسازی', 'bazsazi', 'CHECKBOX', 0, NULL, NULL),
(122, NULL, 26, 'سرمایش', 'cooler', 'RADIOBUTTON', 0, NULL, NULL),
...
(126, NULL, 27, 'آبگرم', 'water_hot', 'RADIOBUTTON', 0, NULL, NULL),
